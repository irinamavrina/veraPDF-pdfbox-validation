 ...
 */
public class PBoxPDNumberTreeNode implements COSObjectable {
	private static final Log LOG = LogFactory.getLog(org.apache.pdfbox.pdmodel.common.PDNumberTreeNode.class);
	 ...
	 */
	public PBoxPDNumberTreeNode(Class<? extends COSObjectable> valueClass) {
	 ...
	 * @param valueClass The PD Model type of object that is the value.
	 */
	public PBoxPDNumberTreeNode(COSDictionary dict, Class<? extends COSObjectable> valueClass) {
		node = dict;
		valueType = valueClass;
	}
	 ...
	 */
	public List<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode> getKids() {
		List<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode> retval = null;
		COSArray kids = (COSArray) node.getDictionaryObject(COSName.KIDS);
		if (kids != null) {
			List<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode> pdObjects = new ArrayList<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode>();
			for (int i = 0; i < kids.size(); i++) {
				pdObjects.add(createChildNode((COSDictionary) kids.getObject(i)));
			}
			retval = new COSArrayList<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode>(pdObjects, kids);
		}
	 ...
	 */
	public void setKids(List<? extends org.apache.pdfbox.pdmodel.common.PDNumberTreeNode> kids) {
		if (kids != null && kids.size() > 0) {
			org.apache.pdfbox.pdmodel.common.PDNumberTreeNode firstKid = kids.get(0);
			org.apache.pdfbox.pdmodel.common.PDNumberTreeNode lastKid = kids.get(kids.size() - 1);
	...
	public Object getValue(Integer index) throws IOException {
		...
		if (names != null) {
			...
			List<org.apache.pdfbox.pdmodel.common.PDNumberTreeNode> kids = getKids();
			if (kids != null) {
				for (int i = 0; i < kids.size() && retval == null; i++) {
					org.apache.pdfbox.pdmodel.common.PDNumberTreeNode childNode = kids.get(i);
	 ...
	 */
	protected org.apache.pdfbox.pdmodel.common.PDNumberTreeNode createChildNode(COSDictionary dic) {
		return new org.apache.pdfbox.pdmodel.common.PDNumberTreeNode(dic, valueType);
	}
